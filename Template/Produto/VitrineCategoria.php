    ...
    <ul class="vitrine-primeira-linha">
        ...
        <?php
                ...
                if( ( ( $count % $countList ) == 0 ) && ( $count < $countTotal ) ):
                    echo '</ul><span class="div-home"></span><ul>';
                endif;
            endforeach;
        ?>
...
<div class="vitrine-geral">
    <ul>
        <li><b>Nenhum produto encontrado.</b></li>
    </ul>
</div><!-- .vitrine-geral -->
<?php
        endif;
